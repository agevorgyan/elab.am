...
export async function generateMetadata(): Promise<Metadata> {
  const page = await getPublishedLegalPageBySlug('privacy');
  return await buildDynamicMetadata('/privacy', {
    title: page?.title ? `${page.title} | eLab.am Digital Studio` : 'Privacy Policy | eLab.am Digital Studio',
      ...
      <section className="pt-36 pb-20 bg-grid-pattern relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00dc93]/10 border border-[#00dc93]/30 text-xs font-bold text-[#00dc93]">
            ...
            <span>Data Protection &amp; Privacy (v{page.version})</span>
          </div>
